      ...
      <div className="header__register">
        <div className="container">
          ...
          <div className="to-login__block">
            Уже есть аккаунт?
            <button className="to-login__btn" onClick={() => navigate("/")}>
              Войти
            </button>
          </div>
        </div>
          ...
          <div className="register__form_block">
            ...
            <form className="register__form" onSubmit={handleSubmit}>
              ...
              <div className="reg-date">
                ...
                <div className="reg-date__input_blocks">
                  <div className="reg-around">
                    <input type="text" className="reg__inp reg__inp_date" placeholder="День" />
                  </div>
                  <div className="reg-between">
                    <input type="text" className="reg__inp reg__inp_date" placeholder="Месяц" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <path d="M4.5 7.5L9 12L13.5 7.5" stroke="#8B5D9A" stroke-width="2" stroke-linecap="round" />
                    </svg>
                  </div>
                  <div className="reg-around">
                    <input type="text" className="reg__inp reg__inp_date" placeholder="Год" />
                  </div>
                </div>
              </div>
              ...
              <div className="reg__input_block inp-and-icon-around">
                ...
                <input type={passShow} placeholder="Введите пароль" />
              ...
              <button type="submit" className="btn__create-acoount">Создать аккаунт</button>
            </form>
          </div>
        </div>
      </div >
